"""Middleware for census_processor request processing."""
import logging
import time
...
class CensusProcessorMiddleware:
    """Middleware that handles census_processor processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("census_processor middleware error: %s", e)
                raise
            finally:
