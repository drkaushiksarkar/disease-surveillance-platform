"""Middleware for disease_classifier request processing."""
import logging
import time
...
class DiseaseClassifierMiddleware:
    """Middleware that handles disease_classifier processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("disease_classifier middleware error: %s", e)
                raise
            finally:
