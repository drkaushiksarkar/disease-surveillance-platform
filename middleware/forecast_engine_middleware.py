"""Middleware for forecast_engine request processing."""
import logging
import time
...
class ForecastEngineMiddleware:
    """Middleware that handles forecast_engine processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("forecast_engine middleware error: %s", e)
                raise
            finally:
