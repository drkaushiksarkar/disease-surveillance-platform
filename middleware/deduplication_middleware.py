"""Middleware for deduplication request processing."""
import logging
import time
...
class DeduplicationMiddleware:
    """Middleware that handles deduplication processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("deduplication middleware error: %s", e)
                raise
            finally:
