"""Service layer for retry_handler operations."""
import logging
...
class RetryHandlerService:
    """Service for retry_handler domain operations."""
    ...
    async def fetch(self, query: Dict[str, Any]) -> RetryHandlerResult:
        ...
        try:
            ...
            return RetryHandlerResult(success=True, data=data, duration_ms=duration)
        except Exception as e:
            logger.error("Fetch failed: %s", e)
            return RetryHandlerResult(success=False, error=str(e))
