"""Utility helper for observation_filter operations."""
import logging
...
class ObservationFilterHelper:
    """Helper class for observation_filter processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing observation_filter helper")
