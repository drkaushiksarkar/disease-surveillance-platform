"""Configuration for zone_mapper subsystem."""
import os
...
@dataclass
class ZoneMapperConfig:
    """Configuration parameters for zone_mapper."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "ZONE_MAPPER") -> "ZoneMapperConfig":
        return cls(
