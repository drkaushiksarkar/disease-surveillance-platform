"""Configuration for replication_manager subsystem."""
import os
...
class ReplicationManagerConfig:
    """Configuration parameters for replication_manager."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "REPLICATION_MANAGER") -> "ReplicationManagerConfig":
        return cls(
