"""Configuration for yield_calculator subsystem."""
import os
...
class YieldCalculatorConfig:
    """Configuration parameters for yield_calculator."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "YIELD_CALCULATOR") -> "YieldCalculatorConfig":
        return cls(
